...
@section('content')
    <main class="main-content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="container">
                    <h6 class="card-title">Crear Editorial</h6>
                    <form method="POST" action="{{route('category.store')}}" enctype="multipart/form-data" >
                        @csrf
                        <div class="form-group row">
                            <label  class="col-sm-2 col-form-label">Nombre de la editorial</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row" data-select2-id="23">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="parent_id" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option selected="selected" value="0">Categoria Principal</option>
